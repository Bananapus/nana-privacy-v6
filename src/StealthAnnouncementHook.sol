...
contract StealthAnnouncementHook is IJBPayHook {
    ...
    /// @notice Called by the terminal after a payment is recorded. Emits the EIP-5564 announcement.
    ...
    function afterPayRecordedWith(JBAfterPayRecordedContext calldata context) external payable override {
        // Extract stealth data from payer metadata.
        (, bytes memory stealthData) =
